...
#
#
# v.13 modified Instruction to allow negative DAT values
...
class Instruction:
    ...
    def validate_operand(self):
        ...
        except ValueError:  # symbolic address handled by assembler - need to fixup is signalled by None operand
            self.opstring = self.operand # make opstring be the label to lookup later
            self.operand = None
        else: # executes if int conversion succeeds
